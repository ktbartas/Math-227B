...
%problem 1c with plots- combine 1a and 1b into 1 module
...
syms x
func=my_lapoly(input1,input2)
minx=min(input1); maxx=max(input1);
fplot(func, [minx maxx])
hold on;
plot(input1,input2,'or')
xlim([0 8]);
ylim([-7 8]);
hold off;
